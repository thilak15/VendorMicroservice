...
namespace VendorMicroServiceTest
{
    public class Tests
    {
        ...
        Vendor vendor = new Vendor { VendorId = 111, VendorName = "Amit", DeliveryCharge = 2150, Rating = 4, ExpectedDateOfDelivery = Convert.ToDateTime("2021-11-22") };
        VendorStock stock = new VendorStock { ProductId = 1, VendorId = 111, StockInHand = 0, ExpectedStockReplenishmentDate = Convert.ToDateTime("2021-11-22") };
        ...
        public void Setup()
        {
            ...
            {
            new Vendor{VendorId = 112,VendorName="Aman",DeliveryCharge=2650,Rating=1,ExpectedDateOfDelivery=Convert.ToDateTime("2021-11-22")},
            new Vendor{VendorId = 113,VendorName="Vikas",DeliveryCharge=2950,Rating=3,ExpectedDateOfDelivery=Convert.ToDateTime("2021-1-2")},
            new Vendor{VendorId = 114,VendorName="Manoj",DeliveryCharge=1120,Rating=5,ExpectedDateOfDelivery=Convert.ToDateTime("2021-03-22")},
            new Vendor{VendorId = 115,VendorName="Sahil",DeliveryCharge=1990,Rating=2,ExpectedDateOfDelivery=Convert.ToDateTime("2021-10-2")}
            };
            ...
            new VendorStock { ProductId = 3, VendorId = 113, StockInHand = 210, ExpectedStockReplenishmentDate =Convert.ToDateTime ("2021-12-12") },
            new VendorStock { ProductId = 1, VendorId = 113, StockInHand = 202, ExpectedStockReplenishmentDate = Convert.ToDateTime("2021-11-25") },
            new VendorStock { ProductId = 3, VendorId = 114, StockInHand = 240, ExpectedStockReplenishmentDate = Convert.ToDateTime("2021-11-27") },
            new VendorStock { ProductId = 2, VendorId = 115, StockInHand = 185, ExpectedStockReplenishmentDate = Convert.ToDateTime("2021-12-03") }
            };
        }
